    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="relative bg-white overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  We build cutting-edge software solutions that help businesses thrive in the digital age. Our team of experts delivers custom applications, web development, and digital strategy consulting.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80" alt="Team working on code" />
        </div>
      </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Custom Web Development</h3>
                  <p className="mt-2 text-base text-gray-500">
                    We build responsive, scalable web applications using the latest technologies and frameworks.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Cloud Solutions</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Scalable cloud infrastructure, migration services, and DevOps practices to optimize your operations.
                  </p>
                </div>
              </div>
      ...
      <div id="about" className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              A team of passionate developers, designers, and strategists dedicated to creating exceptional software solutions.
            </p>
          </div>
              ...
              <div className="mt-5 md:mt-0">
                ...
                <div className="mt-5 bg-white overflow-hidden shadow rounded-lg">
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="mt-2 max-w-xl text-sm text-gray-500">
                      <p>
                        We combine technical expertise with strategic thinking to deliver solutions that not only meet your current needs but position you for future success.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-5 md:mt-0">
                  ...
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="mt-2 max-w-xl text-sm text-gray-500">
                      <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>Innovation that drives real business value</li>
                        <li>Transparency and integrity in all relationships</li>
                        <li>Continuous learning and improvement</li>
                        <li>Client success as our ultimate goal</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 bg-white overflow-hidden shadow rounded-lg">
                  <div className="px-4 py-5 sm:p-6">
                    ...
                    <div className="mt-2 max-w-xl text-sm text-gray-500">
                      <p>
                        Our diverse team brings together expertise across multiple disciplines, technologies, and industries to deliver comprehensive solutions to complex challenges.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div id="portfolio" className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Explore some of our successful client projects and solutions.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {/* Project 1 */}
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <img className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="E-commerce Platform" />
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">E-commerce Platform</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    A scalable e-commerce solution with integrated payment processing, inventory management, and customer analytics.
                  </p>
                  <div className="mt-4">
              ...
              {/* Project 2 */}
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <img className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Healthcare App" />
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Healthcare Mobile App</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    A HIPAA-compliant mobile application for patient management, telemedicine, and health monitoring.
                  </p>
                  <div className="mt-4">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 mr-2">
                      React Native
              ...
              {/* Project 3 */}
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <img className="w-full h-48 object-cover" src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Analytics Dashboard" />
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Analytics Dashboard</h3>
                  <p className="mt-2 text-sm text-gray-500">
                    A real-time data visualization platform for business intelligence and performance monitoring.
                  </p>
                  <div className="mt-4">
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800 mr-2">
                      Vue.js
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-medium text-gray-900">Our Contact Information</h3>
                  <div className="mt-6">
                    <div className="flex">
